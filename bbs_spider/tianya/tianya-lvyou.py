...
logzero.logfile('lvyou.log', maxBytes=50 * 1024 ^ 3)
...
def to_redis(data):
    ...
    r.sadd("tianya_lvyou_url", '{}'.format(data))


def pop_redis():
    r = redis.StrictRedis(host='127.0.0.1', port=6379, decode_responses=True)
    po = r.spop("tianya_lvyou_url")
    return po
...
if __name__ == '__main__':
    ...
    with open('lvyou.log', 'r') as f:
        ls = f.readlines()
        start_url = ls[-1][42:-1]
    # start_url = 'http://bbs.tianya.cn/list.jsp?item=travel&nextid=1103176945000'
