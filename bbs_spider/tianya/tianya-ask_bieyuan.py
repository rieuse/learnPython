...
fh = logging.FileHandler('tianya_bieyuan_log.txt')
...
def get_url_list(url):
    try:
        ...
        ls = etree.HTML(html).xpath('//*[@id="bbs_left_nav"]/div[5]/ul/li/a/@href')  # 天涯别院
...
#     try:
#         html = requests.get(url, headers=headers, timeout=4).content
#         ls = etree.HTML(html).xpath('//*[@id="bbs_left_nav"]/div[5]/ul/li/a/@href')
#         ls = ['http://bbs.tianya.cn' + i for i in ls]
#         # print(ls, len(ls))
#         return ls[2:]
#     except:
...
if __name__ == '__main__':
    ...
    start_url = 'http://bbs.tianya.cn/list.jsp?item=923&nextid=1311411203000'
    ...
    # http://bbs.tianya.cn/list-411-1.shtml 天涯交易所
    # 丽人  46
    # 机票 96
